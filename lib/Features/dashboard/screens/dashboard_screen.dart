...
class DashboardScreen extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // --- 2. KARTU TOTAL PENGHASILAN HARI INI ---
              Container(
              ...
              // --- 3. STATISTIK MATERIAL & PEKERJAAN ---
              Row(
                children: [
                  Expanded(
                    child: _buildStatCard('Material', '48,6 kg', 'Terkumpul', Icons.eco, Colors.green),
                  ),
                  const SizedBox(width: 16),
                  Expanded(
                    child: _buildStatCard('Pekerjaan', '3 Selesai', 'Hari ini', Icons.assignment_turned_in, Colors.blue),
                  ),
                ],
              ),
              const SizedBox(height: 20),

              // --- 4. KARTU LEVEL PARTNER ---
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: Colors.white,
                  ...
                  children: [
                    Row(
                      ...
                      children: const [
                        ...
                        Text('Gold', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.amber)),
                      ],
                    ),
                    const SizedBox(height: 6),
              ...
              const SizedBox(height: 10),
              _buildActivityItem(Icons.swap_horiz, Colors.blue, 'Withdrawal Diproses', '09:15 • Ke Rek. BCA', '-Rp150.000', AppColors.textPrimary),
            ],
          ),
        ),
      ),
  ...
  // Widget Kartu Pekerjaan Tersedia (Horizontal)
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(price, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.primaryGreen)),
                ],
              ),
              ElevatedButton(
                onPressed: () {},
